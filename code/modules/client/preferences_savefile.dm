...
/datum/preferences/proc/load_preferences()
	...
	READ_FILE(S["auto_capitalization"], auto_capitalization)
	...
	auto_capitalization	 =sanitize_integer(auto_capitalization, FALSE, TRUE, initial(auto_capitalization))
...
/datum/preferences/proc/save_preferences()
	...
	WRITE_FILE(S["auto_capitalization"], auto_capitalization)
...
/datum/preferences/proc/load_character(slot)
	...
	READ_FILE(S["antenna_color"], antenna_color)
...
/datum/preferences/proc/save_character()
	...
	WRITE_FILE(S["antenna_color"]				, antenna_color)
