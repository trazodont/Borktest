...
/datum/techweb_node/base
	...
	design_ids = list(
		...
		// Research Stuff
		"destructive_analyzer", "experimentor", "rdconsole", "bepis", "rdserver", "design_disk", "tech_disk", "mechfab", "dcimprinter",
...
/datum/techweb_node/engineering
	...
	"oxygen_tank", "plasma_tank", "emergency_oxygen", "emergency_oxygen_engi", "plasmaman_tank_belt", "pneumatic_seal", "shieldwallgen", "shieldwallgen_atmos", "departmentproto") //WS edit, solar assemblies from lathe
	research_costs = list(TECHWEB_POINT_TYPE_GENERIC = 5000)
	export_price = 5000
